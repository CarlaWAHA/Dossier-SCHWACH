    ...
    <div v-if="started" class="w-full h-full absolute top-0 left-0">
      <div class="w-full h-full relative">
        ...
        <div
          ...
          :key="index"
          class="absolute border-2 border-dashed border-transparent hover:border-white transition-colors duration-200"
          :style="{
            left: zone.x + '%',
            top: zone.y + '%',
            width: zone.width + '%',
    ...
    return {
      ...
      scenes: [
        ...
        },
        {
          ...
          hotspots: [
            { x: 73, y: 70, width: 2, height: 6, targetScene: 2, sound: '' }
          ]
        },
        {
        ...
        },
        {
          ...
          hotspots: [
            { x: 50, y: 50, width: 20, height: 20, targetScene: 5, sound: '' }
          ]
        },
        {
          ...
          hotspots: [
            { x: 50, y: 50, width: 20, height: 20, targetScene: 6, sound: '' }
          ]
        },
        {
